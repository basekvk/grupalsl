                  ...
                  <div className="scroll-content">
                    ...
                    <div className="our-sevice-item">
                      ...
                      <div className="service-item-content">
                        <h3>Excavaciones </h3>
                        <div className="excerpt">
                          Trabajamos de forma rápida, segura y profesional para
                          hacer las excavaciones, piscinas en Madrid, zanjas o
                          movimiento de tierras, entre otros, que nos indiques
                          con un equipo de profesionales y maquinaria propia.
                        </div>
                        <a href="single.html" className="custom-btn">
                          Saber Más <i className="fa fa-angle-double-right" />
                        </a>
