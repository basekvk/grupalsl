...
function pocerosAranjuez() {
  return (
    <>
      <Metas />
      <Header />
      <BannerSingle
        pageTitle={"Poceros en Aranjuez"}
        migasPan={"Poceros en Aranjuez"}
      />
      <ServiceDetails
        ...
        fotoAlt2={""}
        titleService={"POCEROS EN ARANJUEZ"}
        textService1={
        ...
        titleAcordeon1={"Poceros en Aranjuez"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes Aranjuez"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos Aranjuez"}
        textAcordeon3={
...
export default pocerosAranjuez;
