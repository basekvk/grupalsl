...
function limpiezaTuberias() {
  return (
    <>
      <Metas />
      <Header />
      <BannerSingle
        pageTitle={"Limpieza de Tuberías"}
        migasPan={"Limpieza de Tuberías"}
      />
      <ServiceDetails
        ...
        fotoAlt2={""}
        titleService={"Limpieza de tuberías"}
        textService1={
        ...
        textService2={
          "Consejos para el mantenimiento y limpieza de tuberías.No utilizar el WC de papelera: ninguna red de saneamientos debe de ser utilizada como papelera. Verter plásticos, papeles, utensilios para la higiene femenina ( tampones, compresas, etc…), gomas, bastoncillos u hojas de afeitar entre otras muchas cosas que se tiran, esta totalmente contraindicado si no se quiere producir un atasco o rotura en las bajantes o saneamientos.No utilizar productos corrosivos para desatascos: El uso de productos de fuerte corrosión esta muy demandado por el publico, pero es totalmente negativo para la red de saneamientos, ya que pueden causar deterioro y destruir las tuberías y bajantes.No arrojar pinturas, ceras o productos disolventes: estos productos deterioran las tuberías. Estos productos se adhieren en la pared de las tuberías, provocando el cúmulo y provocar un atasco.Manten tu red de saneamientos realizando mantenimientos esporádicos y limpieza de las tuberías. Llámanos y te daremos presupuesto GRATIS y sin compromiso."
        }
...
export default limpiezaTuberias;
