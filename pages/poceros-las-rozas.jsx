...
function pocerosLasRozas() {
  return (
    <>
      <Metas />
      
      <BannerSingle
        pageTitle={"Poceros en Las Rozas"}
        migasPan={"Poceros en Las Rozas"}
      />
      <ServiceDetails
        ...
        fotoAlt2={""}
        titleService={"POCEROS EN LAS ROZAS"}
        textService1={
        ...
        titleAcordeon1={"Poceros en Las Rozas"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes Las Rozas"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos Las Rozas"}
        textAcordeon3={
...
export default pocerosLasRozas;
