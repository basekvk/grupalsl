...
function pocerosColmenar() {
  return (
    <>
      <Metas />
    
      <BannerSingle
        pageTitle={"Poceros Colmenar"}
        migasPan={"Poceros en Colmenar"}
      />
      <ServiceDetails
        ...
        titleAcordeon1={"Poceros en Colmenar"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes Colmenar"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos Colmenar"}
        textAcordeon3={
...
export default pocerosColmenar;
