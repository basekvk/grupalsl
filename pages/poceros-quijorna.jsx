...
function pocerosQuijorna() {
  return (
    <>
      <Metas />
      
      <BannerSingle pageTitle={"Poceros Quijorna"} migasPan={"Brunete"} />
      <ServiceDetails
        foto={"images/home1/client1.jpg"}
        fotoAlt={""}
        foto2={"images/home1/client1.jpg"}
        fotoAlt2={""}
        titleService={"QUIJORNA"}
        textService1={
        ...
        titleAcordeon1={"Poceros en Quijorna"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes Quijorna"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos Quijorna"}
        textAcordeon3={
...
export default pocerosQuijorna;
