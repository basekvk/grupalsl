...
function pocerosArganda() {
  return (
    <>
      <Metas />
      <Header />
      <BannerSingle
        pageTitle={"Poceros Arganda del Rey"}
        migasPan={"Poceros en Arganda del Rey"}
      />
      <ServiceDetails
        ...
        fotoAlt2={""}
        titleService={"POCEROS ARGANDA DEL REY"}
        textService1={
        ...
        titleAcordeon1={"Poceros en Arganda"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes Arganda"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos Arganda"}
        textAcordeon3={
