...
function pocerosFuenlabrada() {
  return (
    <>
      <Metas />
      <Header />
      <BannerSingle
        pageTitle={"Poceros en Fuenlabrada"}
        migasPan={"Poceros en Fuenlabrada"}
      />
      <ServiceDetails
        ...
        fotoAlt2={""}
        titleService={"POCEROS EN FUENLABRADA"}
        textService1={
        ...
        titleAcordeon1={"Poceros en Fuenlabrada"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes Fuenlabrada"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos Fuenlabrada"}
        textAcordeon3={
...
export default pocerosFuenlabrada;
