...
function pocerosAlcorcon() {
  return (
    <>
      <Metas />
      
      <BannerSingle
        pageTitle={"Poceros en Alcorcón"}
        migasPan={"Poceros en Alcorcón"}
      />
      <ServiceDetails
        ...
        fotoAlt2={""}
        titleService={"POCEROS EN ALCORCÓN"}
        textService1={
        ...
        titleAcordeon1={"Poceros en Alcorcón"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes Alcorcón"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos Alcorcón"}
        textAcordeon3={
...
export default pocerosAlcorcon;
