...
function pocerosGetafe() {
  return (
    <>
      <Metas />

      <BannerSingle pageTitle={"Poceros Getafe"} migasPan={"Poceros Getafe"} />
      <ServiceDetails
        foto={"images/home1/client1.jpg"}
        fotoAlt={""}
        foto2={"images/home1/client1.jpg"}
        fotoAlt2={""}
        titleService={"POCEROS EN GETAFE"}
        textService1={
        ...
        titleAcordeon1={"Poceros en Getafe"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes Getafe"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos Getafe"}
        textAcordeon3={
