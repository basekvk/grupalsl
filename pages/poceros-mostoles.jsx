...
function pocerosMostoles() {
    return (
      <>
        <Metas />
        
        <BannerSingle
          pageTitle={"Poceros en Móstoles"}
          migasPan={"Poceros en Móstoles"}
        />
        <ServiceDetails
          ...
          fotoAlt2={""}
          titleService={"POCEROS EN MÓSTOLES"}
          textService1={
          ...
          titleAcordeon1={"Poceros en Móstoles"}
          textAcordeon1={
          ...
          titleAcordeon2={"Desatascos Urgentes Móstoles"}
          textAcordeon2={
          ...
          titleAcordeon3={"Desatrancos Móstoles"}
          textAcordeon3={
...
export default pocerosMostoles;