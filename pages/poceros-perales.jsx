...
function pocerosPerales() {
  return (
    <>
      <Metas />
      
      <BannerSingle
        pageTitle={"Poceros en Perales del Río"}
        migasPan={"Poceros en Perales del Río"}
      />
      <ServiceDetails
        ...
        fotoAlt2={""}
        titleService={"POCEROS EN PERALES DEL RÍO"}
        textService1={
        ...
        titleAcordeon1={"Poceros en Perales del Río"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes Perales del Río"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos Perales del Río"}
        textAcordeon3={
