...
function pocerosSanMartinDeLaVega() {
  return (
    <>
      <Metas />
      
      <BannerSingle
        pageTitle={"San Martín de la Vega"}
        migasPan={"San Martín de la Vega"}
      />
      <ServiceDetails
        ...
        fotoAlt2={""}
        titleService={"POCEROS EN SAN MARTÍN DE LA VEGA"}
        textService1={
        ...
        titleAcordeon1={"Poceros en San Martín de la Vega"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes San Martín de la Vega"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos San Martín de la Vega"}
        textAcordeon3={
...
export default pocerosSanMartinDeLaVega;
