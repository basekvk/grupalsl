...
function pocerosHumanes() {
  return (
    <>
      <Metas />
     
      <BannerSingle
        pageTitle={"Poceros en Humanes"}
        migasPan={"Poceros en Humanes"}
      />
      <ServiceDetails
        ...
        fotoAlt2={""}
        titleService={"POCEROS EN HUMANES"}
        textService1={
        ...
        titleAcordeon1={"Poceros en Humanes"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes Humanes"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos Humanes"}
        textAcordeon3={
