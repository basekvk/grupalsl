...
function desatascos24Horas() {
  return (
    <>
      <Metas />
      
      <BannerSingle
        pageTitle={"Desatascos 24 Horas"}
        migasPan={"Desatascos 24 Horas"}
      />
      <ServiceDetails
        ...
        fotoAlt2={""}
        titleService={"Desatascos 24 Horas"}
        textService1={
          "Mantenemos activo los 365 días del año el servicio de desatascos 24 horas. En este servicio solucionamos cualquier tipo de incidencia a tiempo récord. Nuestra flota de vehículos, de pequeño, medio y gran tamaño, están equipados con la mejor de las tecnologías, se adapta a cualquier tipo de espacio. Disponemos de dos teléfonos de contacto las 24 horas, donde nuestros operarios están atentos a todas las llamadas que puedan entrar, para acudir de inmediato a cualquiera de las urgencia que se presente en cualquier hora del día o noche. "
        }
        textService2={
          "Llevamos 20 años en el mercado de Poceros. Hemos atendido a miles de clientes que han solicitados nuestros servicios, contratando todo tipo de trabajos de pocería y necesitándonos de urgencia en Madrid y sus alrededores. Nuestros clientes son desde particulares hasta grandes empresas. "
        }
        textService3={
          "Ejemplo de clientes que han solicitado nuestros servicios de desatascos urgentes en Madrid."
        }
        textService4={
          "Pisos y viviendas en general con problemas de atascos en bañeras, fregaderos o inodoros.Chalets individuales, adosados o pareados de clientes particulares en general con problemas de atascos en arquetas de hojas o tierra.Colegios con atascos en general de aseos y arquetas de patios.Urbanizaciones con atascos, arquetas deterioradas, problemas de tuberías o bajantes.Restaurantes con problemas de atascos en cocina, fregaderos o en los aseos de los clientes.Instalaciones deportivas con problemas en los desagües de las piscina o vaciado de arquetas en los vestuarios.Hoteles para el mantenimiento de sus instalaciones, queriendo dar siempre el mejor servicio a sus huéspedes.Multinacionales para incidencias o mantenimiento de las instalaciones distribuidas en sus oficinas.Naves industriales, que generan residuos que sin remedio se acumulan en sus arquetas produciendo atrancos."
        }
...
export default desatascos24Horas;
