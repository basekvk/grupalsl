...
function pocerosCubas() {
  return (
    <>
      <Metas />
      <Header />
      <BannerSingle
        pageTitle={"Poceros en Cubas de la Sagra"}
        migasPan={"Poceros en Cubas de la Sagra"}
      />
      <ServiceDetails
        ...
        fotoAlt2={""}
        titleService={"POCEROS EN CUBAS DE LA SAGRA"}
        textService1={
        ...
        titleAcordeon1={"Poceros en Cubas de la Sagra"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes Cubas de la Sagra"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos Cubas de la Sagra"}
        textAcordeon3={
