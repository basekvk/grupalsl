...
function pocerosMadrid() {
    ...
    return (
      <>
        ...
        <BannerSingle
          pageTitle={"Poceros en Madrid"}
          migasPan={"Poceros en Madrid"}
        />
        <ServiceDetails
          ...
          fotoAlt2={""}
          titleService={"POCEROS EN MADRID"}
          textService1={
          ...
          titleAcordeon1={"Poceros en Madrid"}
          textAcordeon1={
          ...
          titleAcordeon2={"Desatascos Urgentes Madrid"}
          textAcordeon2={
          ...
          titleAcordeon3={"Desatrancos Madrid"}
          textAcordeon3={
