...
function pocerosTorrejonDeArdoz() {
  return (
    <>
      <Metas />
      <Header />
      <BannerSingle
        pageTitle={"Poceros Torrejón de Ardoz"}
        migasPan={"Torrejón de Ardoz"}
      />
      <ServiceDetails
        ...
        fotoAlt2={""}
        titleService={"POCEROS TORREJÓN DE ARDOZ"}
        textService1={
        ...
        titleAcordeon1={"Poceros en Torrejón de Ardoz"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes Torrejón de Ardoz"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos Torrejón de Ardoz"}
        textAcordeon3={
...
export default pocerosTorrejonDeArdoz;
