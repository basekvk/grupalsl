...
function pocerosLeganes() {
  return (
    <>
      <Metas />
      
      <BannerSingle
        pageTitle={"Poceros en Leganés"}
        migasPan={"Poceros en Leganés"}
      />
      <ServiceDetails
        ...
        fotoAlt2={""}
        titleService={"POCEROS EN LEGANÉS"}
        textService1={
        ...
        titleAcordeon1={"Poceros en Leganés"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes Leganés"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos Leganés"}
        textAcordeon3={
