...
function pocerosIllescas() {
    return (
      ...
      <BannerSingle
        pageTitle={"Poceros en Illescas"}
        migasPan={"Poceros en Illescas"}
      />
      <ServiceDetails
        ...
        fotoAlt2={""}
        titleService={"POCEROS EN ILLESCAS"}
        textService1={
        ...
        titleAcordeon1={"Poceros en Illescas"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes Illescas"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos Illescas"}
        textAcordeon3={
...
export default pocerosIllescas;
