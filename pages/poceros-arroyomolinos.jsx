...
function pocerosArroyomolinos() {
  return (
    <>
      <Metas />
    
      <BannerSingle
        pageTitle={"Poceros en Arroyomolinos"}
        migasPan={"Poceros en Arroyomolinos"}
      />
      <ServiceDetails
        ...
        fotoAlt2={""}
        titleService={"POCEROS EN ARROYOMOLINOS"}
        textService1={
        ...
        titleAcordeon1={"Poceros en Arroyomolinos"}
        textAcordeon1={
        ...
        titleAcordeon2={"Desatascos Urgentes Arroyomolinos"}
        textAcordeon2={
        ...
        titleAcordeon3={"Desatrancos Arroyomolinos"}
        textAcordeon3={
...
export default pocerosArroyomolinos;
